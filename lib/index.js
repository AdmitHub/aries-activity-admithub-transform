...
export default class AdmitHubTransform extends Activity {
    ...
    transformPellAwardDate(contact) {
        ...
        georgia.finAid.pellAwardDate = new Date(attribute.value); 
        return { ...contact, georgia };
    }
    ...
    transformSAAppl87(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.successAcademy = { ...georgia.successAcademy };
        georgia.successAcademy.qualified = true;
        return { ...contact, georgia };
    }
    ...
    transformSuccessAcademy(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.successAcademy = { ...georgia.successAcademy };
        georgia.successAcademy.accepted = true;
        return { ...contact, georgia };
    ...
    transformTuitionPaymentPlan(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.tuition = { ...georgia.tuition };
        georgia.tuition.paymentplan = true;
        return { ...contact, georgia };
    }
    ...
    transformWithdrawalReason(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.withdrawalReason = attribute.value;
        return { ...contact, georgia };
    }
    ...
    transformWorkstudyAwardAmount(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.workstudyAmount = attribute.value;
        return { ...contact, georgia };
    }
    ...
    transformWorkstudyAwardDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.workstudyAwardDate = new Date(attribute.value);
        return { ...contact, georgia };
    }
