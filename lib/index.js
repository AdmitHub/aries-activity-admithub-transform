...
export default class AdmitHubTransform extends Activity {
    ...
    transformSuccessAcademyQualified(contact) {
        const attribute = find(contact.attributes, (obj) => {
            return obj.mappingName === 'SA_Appl_87';
        });

        if (!attribute || attribute.value === '87') {
    ...
    transformSuccessAcademyAppReceived(contact) {
        const attribute = find(contact.attributes, (obj) => {
        ...
        const value = attribute.value === 'Y';
        let georgia = { ...contact.georgia };
        georgia.successAcademy = { ...georgia.successAcademy, appReceived: value };
        return { ...contact, georgia };
    }

    transformSuccessAcademyAppAccepted(contact) {
        const attribute = find(contact.attributes, (obj) => {
        ...
        const value = attribute.value === 'Y';
        let georgia = { ...contact.georgia };
        georgia.successAcademy = { ...georgia.successAcademy, accepted: value };
        return { ...contact, georgia };
    }
    ...
    transformTuitionPaymentPlan(contact) {
        ...
        const value = attribute.value === 'Y';
        let georgia = { ...contact.georgia };
        georgia.tuition = { ...georgia.tuition, paymentPlan: value };
        return { ...contact, georgia };
    }
