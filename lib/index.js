...
export default class AdmitHubTransform extends Activity {
    ...
    transformHousingDepositDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.housing = { ...georgia.housing, depositDate: moment(new Date(attribute.value)).fornmat('MM/DD/YY') , depositPaid: true };
        return { ...contact, georgia };
    }
    ...
    transformAppCompleteDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application, appCompleteDate:  moment(new Date(attribute.value)).format('MM/DD/YY')};
        return { ...contact, georgia };
    }
