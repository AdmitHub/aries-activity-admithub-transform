...
export default class AdmitHubTransform extends Activity {
    ...
    transformContact(stream) {
        ...
        .pipe(map.obj(::this.transformSuccessAcademyAppReceived))
        .pipe(map.obj(::this.transformSuccessAcademyAppAccepted))
    ...
    transformFinAidOutstanding(contact) {
        ...
        if (!attribute || attribute.value === '') {
            contact.georgia.finAid = { ...contact.georgia.finAid, finAidComplete: null };
            return contact;
        }

        const value = attribute.value !== 'Y';
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid, finAidComplete: value };
        return { ...contact, georgia };
    }
    ...
    transformHousingDepositDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.housing = { ...georgia.housing, depositDate: new Date(attribute.value), depositPaid: true };
        return { ...contact, georgia };
    }
    ...
    transformResidency(contact) {
        ...
        let georgia = { ...contact.georgia, residency: residencyValue };
        return { ...contact, georgia };
    }
    ...
    transformReceivedHSTranscript(contact) {
        ...
        if (!attribute || attribute.value === '' || attribute.value === 'N') {
            contact.georgia.application = { ...contact.georgia.application, receivedHSTranscript: false };
            return contact;
        }
    ...
    transformPellAwardDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid, pellAwardDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformSAAppl87(contact) {
        ...
        if (!attribute || attribute.value === '') {
            ...
            contact.georgia.successAcademy = { ...contact.georgia.successAcademy, qualified: false };
            return contact;
        }
    ...
    transformSAApplReceived(contact) {
        ...
        if (!attribute || attribute.value === "") {
            contact.georgia.successAcademy = { ...contact.georgia.successAcademy, appReceived: null };
            return contact;
        } else if (attribute && attribute.value === "N"){
            contact.georgia.successAcademy = { ...contact.georgia.successAcademy, appReceived: false};
            return contact;
        }
    ...
    transformWithdrawalReason(contact) {
        ...
        let georgia = { ...contact.georgia, withdrawalReason: attribute.value };
        return { ...contact, georgia };
    }
    ...
    transformWorkstudyAwardDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid, workstudyAwardDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformAppCompleteDate(contact) {
        const attribute = find(contact.attributes, (obj) => {
            return obj.mappingName === 'App Complete Date';
        });

        if(!attribute || attribute.value === '') {
            contact.georgia.application = { ...contact.georgia.application, appCompleteDate: null };
            return contact;
        }

        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application, appCompleteDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformDecisionDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application, decisionDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformFAFSAVerificationDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid, fafsaVerificationFlagDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformHopeAwardDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.georgia = { ...georgia.georgia, hopeAwardDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformMPNPerkins(contact) {
        ...
        if(!attribute || attribute.value === '') {
            contact.georgia.finAid = { ...contact.georgia.finAid, mpnPerkinsComplete: null };
            return contact;
        } else if (attribute && attribute.value === 'N') {
            contact.georgia.finAid = { ...contact.georgia.finAid, mpnPerkinsComplete: false };
            return contact;
        }

        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid, mpnPerkinsComplete: true  };
        return { ...contact, georgia  };
    }
    ...
    transformMPNStaffordPlus(contact) {
        ...
        if(!attribute || attribute.value === '') {
            contact.georgia.finAid = { ...contact.georgia.finAid, mpnStaffordPlusComplete: null };
            return contact;
        } else if (attribute && attribute.value === 'N') {
            contact.georgia.finAid = { ...contact.georgia.finAid, mpnStaffordPlusComplete: false };
            return contact;
        }

        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid, mpnStaffordPlusComplete: true  };
        return { ...contact, georgia  };
    }

    transformCompletedEntrLoanCounseling(contact){
        console.log('adding finaid entranceCounselingComplete');
        const attribute = find(contact.attributes, (obj) => {
            return obj.mappingName === 'Completed_Entr_Loan_Counseling';
        });

        if(!attribute || attribute.value === '') {
            contact.georgia.finAid = { ...contact.georgia.finAid, entranceCounselingComplete: null };
            return contact;
        } else if (attribute && attribute.value === 'N') {
            contact.georgia.finAid = { ...contact.georgia.finAid, entranceCounselingComplete: false };
            return contact;
        }

        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid, entranceCounselingComplete: true  };
        return { ...contact, georgia  };
    }
