...
export default class AdmitHubTransform extends Activity {
    ...
    transformAdmitHubHonorsProspect(contact) {
        ...
        if (!attribute || attribute.value === '' || attribute.value === 'N') {
            contact.georgia._georgia = { ...contact.georgia._georgia, honorsProspect: false };
            return contact;
        }

        let georgia = { ...contact.georgia };
        georgia._georgia = { ...georgia._georgia };

        georgia._georgia.honorsProspect = true; 
        return { ...contact, georgia };
    }
    ...
    transformHonors(contact) {
        ...
        if (!attribute || attribute.value === '' || attribute.value === 'N') {
            contact.georgia._georgia = { ...contact.georgia._georgia, honors: false };
            return contact;
        }
