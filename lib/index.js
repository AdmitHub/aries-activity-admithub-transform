...
export default class AdmitHubTransform extends Activity {
    ...
    transformStudentStatusCategory(contact) {
        ...
        if (attribute.value === 'Confirmed') {
            georgia.intent = { ...georgia.intent, intendsToEntroll: true };
        } else if (attribute.value === 'Admit') {
            georgia.intent = { ...georgia.intent, intendsToEntroll: false };
        }
    ...
    transformIntentReceivedDate(contact) {
        ...
        if (!attribute || attribute.value === '') {
            contact.georgia.intent = { ...contact.georgia.intent, intendsToEnroll: null, intentReceivedDate: null };
            return contact;
        }
