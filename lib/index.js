import { Activity, singleS3StreamInput, singleS3StreamOutput } from 'astronomer-aries';
...
export default class AdmitHubTransform extends Activity {
    ...
    async onTask(activityTask, config) {
        return activityTask.input.file
        .pipe(map.obj(this.transformID))
    ...
    transformNickName(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.name = { ...georgia.name, nick: attribute.value };
        return { ...contact, georgia };
    }
    ...
    transformLevelOfInterestInGSU(contact) {
        ...
        const georgia = { ...contact.georgia, crm: attribute.value };
        return { ...contact, georgia }
    }
    ...
    transformHousingDepositDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        const depositPaid = georgia.housing.onCampus && attribute.value;
        georgia.housing = { ...georgia.housing, depositDate: new Date(attribute.value), depositPaid: depositPaid };
        return { ...contact, georgia };
    }
    ...
    transformIntentReceivedDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        const intendsToEntroll = attribute.value && georgia.application.status === 'Enrolled';
        georgia.intent = { ...georgia.intent, intentReceivedDate: new Date(attribute.value), intendsToEntroll: intendsToEntroll }; 
        return { ...contact, georgia };
    }
};
