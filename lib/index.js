...
export default class AdmitHubTransform extends Activity {
    ...
    transformAdmitHubUser(contact) {
        ...
        if (!attribute || attribute.value === '' || attribute.value === 'No') {
    ...
    transformAcceptedFederalLoan(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.fedLoanAccepted = true;
    ...
    transformAidGap(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.aidGap = attribute.value;
        return { ...contact, georgia };
    }
    ...
    transformAppCompleteDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application };
        georgia.application.appCompleteDate = new Date(attribute.value);
    ...
    transformDecisionDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application };
        georgia.application.decisionDate = new Date(attribute.value);
    ...
    transformDecisionPlan(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.application = { ...georgia.application };
        georgia.application.decisionType = attribute.value;
    ...
    transformFAFSAVerificationDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.fafsaVerificationFlagDate = new Date(attribute.value);
    ...
    transformFinancialAidInterest(contact) {
      ...
      let georgia = { ...contact.georgia };
      georgia.finAid = { ...georgia.finAid };
      georgia.finAid.finAidInterest = true;
    ...
    transformHighSchoolGraduationYear(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.profile = { ...georgia.profile };
        georgia.profile.hsGradYear = attribute.value;
    ...
    transformHighSchoolCode(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.profile = { ...georgia.profile };
        georgia.profile.hsCode = attribute.value;
    ...
    transformHopeAwardAmount(contact) {
        ...
        georgia.georgia.hopeAwardAmount = attribute.value;
    ...
    transformHopeAwardDate(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.georgia = { ...georgia.georgia };
        georgia.georgia.hopeAwardDate = new Date(attribute.value);
    ...
    transformHOPGSF(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.georgia = { ...georgia.georgia };
        georgia.georgia.hopeGSFAppSubmitted = true
    ...
    transformMajorCollege(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.profile = { ...georgia.profile };
        georgia.profile.intendedCollege = attribute.value;
    ...
    transformMajorInterest(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.profile = { ...georgia.profile };
        georgia.profile.majorInterest = attribute.value;
    ...
    transformOfferedFederalLoan(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.fedLoanOffered = true;
    ...
    transformPellAwardAmount(contact) {
        ...
        let georgia = { ...contact.georgia };
        georgia.finAid = { ...georgia.finAid };
        georgia.finAid.pellAwardAmount = attribute.value;
    ...
    transformMPNPerkins(contact) {
        ...
        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid  };
        georgia.finAid.mpnPerkinsComplete = true;
    ...
    transformMPNStaffordPlus(contact) {
        ...
        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid  };
        georgia.finAid.mpnStaffordPlusComplete = true;
    ...
    transformCompletedEntrLoanCounseling(contact){
        ...
        let georgia = { ...contact.georgia  };
        georgia.finAid = { ...georgia.finAid  };
        georgia.finAid.entranceCounselingComplete = true;
