...
export default class AdmitHubTransform extends Activity {
    ...
    transformPellAwardDate (contact) {
        ...
        if (!attribute || attribute.value === '') {
            contact.georgia = { ...contact.georgia, finAid.pellAwardDate: null };
            return contact;
        }

        const georgia = { ...contact.georgia, finAid.pellAwardDate: new Date(attribute.value) };
        return { ...contact, georgia };
    }
    ...
    transformSuccessAcademyQualified(contact) {
        ...
        if (!attribute || attribute.value === '' || attribute.value === '87') {
            contact.georgia.application = { ...contact.georgia.application, georgia.successAcademy.qualified: true };
            return contact;
        }
        ...
        georgia.application.georgia.successAcademy.qualified = true;
        return { ...contact, georgia };
    }
